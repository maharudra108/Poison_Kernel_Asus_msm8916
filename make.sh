...
KERNEL_DIR=$PWD
KERNEL_TOOLCHAIN=~/aarch64-linux-android-4.9-linaro/bin/aarch64-linux-android-
ZFM_CONFIG=Z00L_defconfig
DTBTOOL=$KERNEL_DIR/tools/
BUILDS=../zip
BUILD_DIR=$KERNEL_DIR/zip
ANY_KERNEL2_DIR=$KERNEL_DIR/zip/base_files
STRIP=~/aarch64-linux-android-4.9-linaro/bin/aarch64-linux-android-strip
